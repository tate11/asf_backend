odoo.define('app.web.planner', function (require) {
    "use strict";
    ...
    SystrayMenu.Items.push(AppPlannerLauncher);
    
    return {
        AppPlannerLauncher: AppPlannerLauncher,
    };
