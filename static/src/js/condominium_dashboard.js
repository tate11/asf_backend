odoo.define('condominium.dashboard', function (require) {
    "use strict";
    ...
    var CondominiumDashboardView = KanbanView.extend({
        ...
        render: function() {
            ...
            return this.fetch_data().then(function(result){
                ...
                var sales_dashboard = QWeb.render('CondominiumDashboard', {
                    widget: self,
    ...
    core.view_registry.add('CondominiumDashboard', CondominiumDashboardView);
    
    return CondominiumDashboardView;
