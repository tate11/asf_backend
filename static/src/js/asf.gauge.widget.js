odoo.define('web_kanban_asf_gauge.widget', function (require) {
    "use strict";
    ...
    var AsfWidget = AbstractField.extend({
        className: "oe_asf_gauge",
        ...
        start: function() {
            ...
            //     max_value = this.options.max_field;
            // }
            ...
            if (this.options.gauge_value_field) {
                gauge_value = this.options.gauge_value_field;
            }
    ...
    fields_registry.add("asf_gauge", AsfWidget);
