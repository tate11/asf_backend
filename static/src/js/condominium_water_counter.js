odoo.define('condominium.water_counter', function(require) {
    "use strict";
    // alert('condominium.water_counter');
    ...
    var water_counter_model = new Model('condominium.water_counter');

    water_counter_model.call('regards');
